...
using namespace std;
string saludo = "Hola Carmen Quintás!"; // Variable GLOBAL
...
{
	// Variable LOCAL (de la función): ES UN PARÁMETRO DE LA FUNCIÓN
...
string funcionConRetornoYSinArgs()
{
	...
	string saludo; // Variable LOCAL (de la función)
...
int main()
{
	...
	string saludo = "Hola Carmen!"; // Variable LOCAL (del main) que se pasa por valor
